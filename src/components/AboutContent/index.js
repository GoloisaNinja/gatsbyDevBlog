...
export function AboutContent() {
  ...
  return (
    <Theme>
      <AboutContentWrapper>
        <h3>What I do and what I do it with.</h3>
        <p>
          ...
          that was where my heart was. I started with Vanilla JavaScript and
          tried to learn the fundamentals. Then I pivoted to libraries and
          frameworks, like React and Gatsby. I really enjoy working with the
        ...
        <h3>Why I started this developer blog.</h3>
        <p>
          ...
          ideas out into the interwebs. But, that would be a lie. If anything,
          my hope is that this blog will help me develop, and nurture my writing
          ...
          <br />
          <br />
          I'll do my best to try and cover a wide range of topics and to also
          post as regularly as I can. I also think there will be value (not just
          in my crazy ideas/theories) in documenting my (mis) adventures as I
          learn new technologies, develop new projects and applications, and
          just generally make my way through the new career path I've set myself
          on. I can't guarantee the content will be riveting, or that I will
          keep you coming back with great tech tips and walkthoughs. But I can
          ...
          strengths and speed of Gatsby (fast project startup/scalablity) with
          the power of a content managment system. A blog works very well for
          this. I was able to design the frontend using my own frameworks,
          libraries, design aesthetics and templating. Meanwhile, I can simply
          inject markdown "articles" into my decoupled CMS on the backend. A few
          magical webhooks later, and content is posted and templated. It's been
          a fun project to create, and I was astonished at how quickly I was
          able to get it all off the ground.
          <br />
          <br />
